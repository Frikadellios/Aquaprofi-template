...
const images = {
				...
				const frontmatter = {"title":"h2.0","publishDate":"2019-10-02T00:00:00.000Z","img":"/assets/stock-4.jpg","img_alt":"Soft pink and baby blue water ripples together in a subtle texture.","description":"We developed brand positioning and design assets for the launch\nof a new colored water product.\n","tags":["Design","Branding"]};
				const file = "/workspaces/Aquaprofi-template/src/content/work/h20.md";
				const url = undefined;
				function rawContent() {

/* empty css                         */import { c as createAstro, a as createComponent, r as renderTemplate, b as addAttribute, m as maybeRenderHead, s as spreadAttributes, u as unescapeHTML, d as renderComponent, e as renderHead, f as renderSlot } from '../astro_ce1a6869.mjs';
import 'clsx';
/* empty css                           */
...
var _a;
const $$Astro$7 = createAstro("https://aquaprofi.com");
...
}, "/workspaces/Aquaprofi-template/src/components/MainHead.astro", void 0);
...
const $$Astro$6 = createAstro("https://aquaprofi.com");
const $$Icon = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 256 256" aria-hidden="true"${addAttribute(gradient ? `url(#${gradientId})` : color, "stroke")}${addAttribute(gradient ? `url(#${gradientId})` : color, "fill")}${spreadAttributes(attrs, "attrs", { "class": "astro-patnjmll" })} data-astro-cid-patnjmll><g data-astro-cid-patnjmll>${unescapeHTML(iconPath)}</g>${gradient && renderTemplate`<linearGradient${addAttribute(gradientId, "id")} x1="23" x2="235" y1="43" y2="202" gradientUnits="userSpaceOnUse" data-astro-cid-patnjmll><stop stop-color="var(--gradient-stop-1)" data-astro-cid-patnjmll></stop><stop offset=".5" stop-color="var(--gradient-stop-2)" data-astro-cid-patnjmll></stop><stop offset="1" stop-color="var(--gradient-stop-3)" data-astro-cid-patnjmll></stop></linearGradient>`}</svg>`;
}, "/workspaces/Aquaprofi-template/src/components/Icon.astro", void 0);

const $$Astro$5 = createAstro("https://aquaprofi.com");
...
}, "/workspaces/Aquaprofi-template/src/components/ThemeToggle.astro", void 0);

const $$Astro$4 = createAstro("https://aquaprofi.com");
...
}, "/workspaces/Aquaprofi-template/src/components/Nav.astro", void 0);
...
Designed & Developed in Portland with <a href="https://astro.build/" data-astro-cid-sz7xmlte>Astro</a>${renderComponent($$result, "Icon", $$Icon, { "icon": "rocket-launch", "size": "1.2em", "data-astro-cid-sz7xmlte": true })}</p><p data-astro-cid-sz7xmlte>&copy; ${currentYear} Jeanine White</p></div><p class="socials" data-astro-cid-sz7xmlte><a href="https://twitter.com/me" data-astro-cid-sz7xmlte> Twitter</a><a href="https://github.com/me" data-astro-cid-sz7xmlte> GitHub</a><a href="https://codepen.io/me" data-astro-cid-sz7xmlte> CodePen</a></p></footer>`;
}, "/workspaces/Aquaprofi-template/src/components/Footer.astro", void 0);
...
}, "/workspaces/Aquaprofi-template/src/layouts/BaseLayout.astro", void 0);
...
}, "/workspaces/Aquaprofi-template/src/components/Hero.astro", void 0);
...
}, "/workspaces/Aquaprofi-template/src/pages/404.astro", void 0);

const $$file = "/workspaces/Aquaprofi-template/src/pages/404.astro";
const $$url = "/404";

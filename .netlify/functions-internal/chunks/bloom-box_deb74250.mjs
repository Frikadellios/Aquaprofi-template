import { a as createComponent, r as renderTemplate, m as maybeRenderHead, u as unescapeHTML, s as spreadAttributes } from './astro_ce1a6869.mjs';
import '@astrojs/internal-helpers/path';
import './pages/image-endpoint_7c9fcec2.mjs';
import 'clsx';
import 'html-escaper';
import 'mime/lite.js';
...
const images = {
				...
				const frontmatter = {"title":"Bloom Box","publishDate":"2019-12-01T00:00:00.000Z","img":"/assets/stock-2.jpg","img_alt":"A bright pink sheet of paper used to wrap flowers curves in front of rich blue background","description":"We paired with a cutting-edge music API and a team of horticulturalists\nto build AI-generated playlists that maximize houseplant health.\n","tags":["Dev","Branding","Backend"]};
				const file = "/workspaces/Aquaprofi-template/src/content/work/bloom-box.md";
				const url = undefined;
				function rawContent() {
